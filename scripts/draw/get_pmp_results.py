...
for workload in workloads_simplified:
    ...
    try:
        ...
        if total_prefetches > 0:
            overall_accuracy = total_useful / total_prefetches
...
mean_overall_accuracy = df_detail['pmp_Overall_Accuracy'].mean()
mean_coverage = df_detail['pmp_LLC_Coverage'].mean()
mean_l1_accuracy = df_detail['pmp_L1D_Accuracy'].mean()
mean_l2_accuracy = df_detail['pmp_L2C_Accuracy'].mean()

# Mean Useful/Useless (as in Fig 10)
mean_l1_useful = df_detail['pmp_L1D_Useful'].mean()
mean_l1_useless = df_detail['pmp_L1D_Useless'].mean()
mean_l2_useful = df_detail['pmp_L2C_Useful'].mean()
mean_l2_useless = df_detail['pmp_L2C_Useless'].mean()
...
summary_data = {
    ...
    'pmp_Mean_Overall_Accuracy': mean_overall_accuracy,
    'pmp_Mean_LLC_Coverage': mean_coverage,
    'pmp_Mean_Late_Ratio': mean_late_ratio,
    'pmp_Mean_L1D_Accuracy': mean_l1_accuracy,
    'pmp_Mean_L2C_Accuracy': mean_l2_accuracy,
    'pmp_Mean_L1D_Useful': mean_l1_useful,
    'pmp_Mean_L1D_Useless': mean_l1_useless,
    'pmp_Mean_L2C_Useful': mean_l2_useful,
    'pmp_Mean_L2C_Useless': mean_l2_useless
}
